...
class HrExpense(models.Model):
    ...
    def action_move_create(self):
        ...
        for expense in self:
            ...
            if not expense.sheet_id.id in move_in_group:
                ...
                move_in_group[expense.sheet_id.id] = move
            else:
                move = move_in_group[expense.sheet_id.id]
            ...
            for move in move_in_group.values():
                move.post()
            if expense.payment_mode == 'company_account':
