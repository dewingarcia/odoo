odoo.define("website.theme.instance", function (require) {
    "use strict";

    var ThemeCustomizationDialog = require("website.theme");
    var WebsiteNavbar = require('website.navbar');

    WebsiteNavbar.include({
        events: _.extend(WebsiteNavbar.prototype.events || {}, {
            "click #theme_customize a": function () {
                this.openThemeCustomizationDialog();
            },
        }),
        start: function () {
        ...
        openThemeCustomizationDialog: function () {
            new ThemeCustomizationDialog(this).appendTo(document.body);
        },
    });
});
...
odoo.define('website.theme', function (require) {
    ...
    var rpcDefs = [];
    rpcDefs.push(ajax.jsonRpc('/web/dataset/call', 'call', {
        model: 'ir.ui.view',
        method: 'read_template',
        args: ['website.theme_customize', webEditorContext.get()]
    }).then(function (data) {
