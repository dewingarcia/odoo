odoo.define("website.content.snippets.animation.start.instance", function (require) {
    "use strict";
    ...
    base.ready().always(function () {
        _.defer(s_animations_start);
    });
});

odoo.define("website.content.snippets.animation.start", function (require) {
    "use strict";

    var s_animations = require("website.content.snippets.animation");
     ...
     *                                  "selector" matches it
     */
    return function (editable_mode, $init_target) {
        _.each(s_animations.registry, function (Animation) {
...
odoo.define("website.content.snippets.animation", function (require) {
     ...
     * Also register AnimationComponent's automatically according to the methods it defines. Also allows to
     * register them in more conventional ways by extending the _prepareComponents method and calling the
     * _addComponent method.
     */
    var Animation = Class.extend({
         ...
         * Also, prepare animation components and start them if any.
         * @param editable_mode - A boolean which is true if the page is in edition mode
         ...
         * Also stop animation components and destroy them if any.
         */
        stop: function () {
            _.each(this._animationComponents, function (component) {
                component.stop();
    ...
    registry.media_video = Animation.extend({
    ...
    registry.gallery_slider = Animation.extend({
     ...
     */
    registry._fix_apple_collapse = Animation.extend({
