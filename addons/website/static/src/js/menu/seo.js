odoo.define("website.seo.instance", function (require) {
    "use strict";

    var WebsiteNavbar = require("website.navbar");
    var SeoConfigurator = require("website.seo");

    WebsiteNavbar.include({
        events: _.extend(WebsiteNavbar.prototype.events || {}, {
            "click a[data-action=promote-current-page]": function () {
...
odoo.define("website.seo", function (require) {
    ...
    var SuggestionList = Widget.extend({
        ...
        refresh: function () {
            ...
            var language = self.language || webEditorContext.get().lang.toLowerCase();
    ...
    return Dialog.extend({
        ...
        loadMetaData: function () {
            ...
            if (!obj) {
                ...
                new Model(obj.model).call('read', [[obj.id], fields, webEditorContext.get()]).then(function (data) {
                    if (data.length) {
                        var meta = data[0];
        ...
        saveMetaData: function (data) {
            ...
            if (!obj) {
                ...
                return new Model(obj.model).call('write', [[obj.id], data, webEditorContext.get()]);
            }
        },
