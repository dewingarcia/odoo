...
class ProductUomCateg(models.Model):
    ...
    is_product_groupable = fields.Boolean(string='Group Products in POS', help="Check if you want to group products of this category in Point of Sale")


class ProductUom(models.Model):
    _inherit = 'product.uom'

    is_product_groupable = fields.Boolean(related='category_id.is_product_groupable')
