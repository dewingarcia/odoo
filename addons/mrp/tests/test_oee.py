...
class TestOee(TestMrpCommon):
    ...
    def test_wrokcenter_oee(self):
        ...
        self.create_productivity_line(self.env.ref('mrp.block_reason7'), '2017-03-20 10:43:22', '2017-03-20 10:56:22')

        # Material Availability time duration (1.52 min)

        # Check working state is blocked or not.
        workcenter_productivity_1 = self.create_productivity_line(self.env.ref('mrp.block_reason0'), '2017-03-20 10:47:08')
        ...
        workcenter_productivity_1.write({'date_end': "2017-03-20 10:48:39"})
        ...
        self.create_productivity_line(self.env.ref('mrp.block_reason5'), '2017-03-20 10:48:38', '2017-03-20 10:49:58')
        # Reduced Speed time duration (3.0 min)
        self.create_productivity_line(self.env.ref('mrp.block_reason4'), '2017-03-20 10:50:22', '2017-03-20 10:53:22')
