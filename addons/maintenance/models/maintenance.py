...
class MaintenanceEquipment(models.Model):
    ...
    def _compute_next_maintenance(self):
        ...
        for maintenance in maintenance_request:
            if maintenance.schedule_date:
                self.next_action_date = maintenance.schedule_date
                break
    ...
    def create(self, vals):
        ...
        if any(vals.get(x, False) != 0 for x in fields):
        ...
        if self.calendar.exists() and self.calendar.recurrency and fields.Datetime.now() < self.calendar.final_date:
            ...
            for event in self.calendar._get_recurrent_date_by_event():
                ...
                if event > now and event > event_start:
                    ...
                    future_calendar = virtual_event.split_recurring_event()
                    data = {
